...
const page = () => {
  return (
    <div className="container py-4 break-normal">
      <h1 className="text-3xl font-bold">Datenschutzerklärung</h1>
      <h2 className="text-xl font-semibold my-4">Präambel</h2>
      <p>
      ...
      <p>Stand: 14. November 2023</p>
      <h2 className="text-xl font-semibold my-4 my-">Verantwortlicher</h2>
      <p>
        Irina Wambach
        <br />
        Hallstadter Str. 75
      ...
      <h3 className="font-medium my-4">Arten der verarbeiteten Daten</h3>
      ...
      <h3 className="font-medium my-4">Kategorien betroffener Personen</h3>
      <ul className="space-y-1 list-disc list-inside">
        <li>Kunden.</li>
        <li>Interessenten.</li>
        <li>Nutzer.</li>
      </ul>
      <h3 className="font-medium my-4">Zwecke der Verarbeitung</h3>
      <ul className="space-y-1 list-disc list-inside">
        <li>
      ...
      <h2 className="text-xl font-semibold my-4">Sicherheitsmaßnahmen</h2>
      <p>
      ...
      <h2 className="text-xl font-semibold my-4">Geschäftliche Leistungen</h2>
      <p>
      ...
      <ul className="space-y-1 list-disc list-inside">
        ...
        <li>
          <strong>Stripe: </strong>Wir bieten die Möglichkeit, den
          Zahlungsvorgang über den Zahlungsdienstleister Stripe, ℅ Legal
          Process, 510,Townsend St., San Francisco, CA 94103 (Stripe)
          abzuwickeln. Dies entspricht unserem berechtigten Interesse, eine
          effiziente und sichere Zahlungsmethode anzubieten (Art. 6 Abs. 1 lit.
          f DSGVO). In dem Zusammenhang geben wir folgende Daten an Stripe
          weiter, soweit es für die Vertragserfüllung erforderlich ist (Art. 6
          Abs. 1 lit b. DSGVO):
          <ul className="space-y-1 list-disc list-inside">
          ...
          über Stripe nicht durchführen. Stripe nimmt bei
          Datenverarbeitungstätigkeiten eine Doppelrolle als Verantwortlicher
          und Auftragsverarbeiter ein. Als Verantwortlicher verwendet Stripe
          Ihre übermittelten Daten zur Erfüllung regulatorischer
          ...
          Einfluss. Als Auftragsverarbeiter fungiert Stripe, um Transaktionen
          innerhalb der Zahlungsnetzwerke abschließen zu können. Im Rahmen des
          ...
          EU-Standardvertragsklauseln (SCCs). Weitere Informationen zu
          Widerspruchs- und Beseitigungsmöglichkeiten gegenüber Stripe finden
          Sie unter: https://stripe.com/privacy-center/legal Ihre Daten werden
          von uns bis zum Abschluss der Zahlungsabwicklung gespeichert. Dazu
          zählt auch der Zeitraum der für die Bearbeitung von Rückerstattungen,
      ...
      <p>
        ...
        oder Plug-ins von Drittanbietern (kurz &quot;Dienste&quot;).
      </p>
      <ul className="space-y-1 list-disc list-inside">
        <li>
          <strong>Verarbeitete Datenarten:</strong> Bestandsdaten (z. B. Namen,
